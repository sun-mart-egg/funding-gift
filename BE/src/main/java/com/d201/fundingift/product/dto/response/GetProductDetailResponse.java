...
public class GetProductDetailResponse {
    ...
    @Builder
    private GetProductDetailResponse(Long productId, String productName, Integer price, String imageUrl, String description, Boolean isWishlist, Integer reviewCnt, Double reviewAvg, List<GetProductOptionResponse> options) {
    ...
    public static GetProductDetailResponse from(Product product, List<GetProductOptionResponse> options, boolean isWishlist) {
        return builder()
