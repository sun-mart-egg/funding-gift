...
function ProductSearchComponent({ keyword, sort }) {
  console.log(keyword, sort);
  console.log(`https://j10d201.p.ssafy.io/api/products/search?keyword=${keyword}&page=0&size=10&sort=${sort}`)
  ...
  const loadProducts = async (page) => {
    setLoading(true);
    try {
      const response = await fetch(`https://j10d201.p.ssafy.io/api/products/search?keyword=${keyword}&page=0&size=10&sort=${sort}`);
