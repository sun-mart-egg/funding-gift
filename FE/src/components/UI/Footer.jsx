...
function Footer() {
  ...
  return (
    <footer className="fixed border-t-[2px] bottom-0 left-0 bg-white w-full max-w-[500px] mx-auto text-center flex justify-between pt-1 px-[10%] items-center space-x-4">
      <img
