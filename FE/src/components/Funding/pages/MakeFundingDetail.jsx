    ...
    const renderContent = () => {
        switch (contentIndex) {
            case 0:
                return (
                    <div>
                        <div id="imgSection" className="text-center mb-8">
                            <img src="" alt="" />
                        </div>
                        <div id="itemInfo">
                            <p> 에어팟 맥스</p>
            ...
            case 1:
                return (
                    <div>
                        ...
                        <p>펀딩 소개:</p>
                        <textarea type="text" name="intro" value={formData.intro} onChange={handleInputChange} />
                    </div>
                );
            case 2:
                return (
                    <div>
                        ...
                        />
                        <p>최소금액</p>
                        <input type="text" name="minMoney" value={formData.minMoney} onChange={handleInputChange} />
                    </div>
                );
            case 3:
                return (
            ...
            case 4:
                return (
                    <div>
                        <img src="" alt="" />
                        <p>{formData.bestFriend ? "친한 친구에게만 공개하기" : "모두에게 공개하기"}</p>
                        <p>{formData.title}</p>
                        <p>{formData.intro}</p>
    ...
    return (
        <div className="bg-slate-300 h-screen flex-col justify-center items-center">
            ...
            <div id="buttonSection" className="flex justify-around w-full">
                {contentIndex > 0 ? (
                    <>
                        <button onClick={handlePrev} style={{ flexBasis: "40%" }} className="bg-cusColor3 rounded-lg">
                            이전
                        </button>
                        <button onClick={handleNext} style={{ flexBasis: "40%" }} className="bg-cusColor4 rounded-lg">
                            다음
                        </button>
                    </>
                ) : (
