    ...
    >
      <div className="flex max-h-96 w-full flex-col  justify-center font-cusFont4">
        ...
        >
          <div
            id="message"
            className="mx-auto mb-20 flex h-2/5 w-[85%] flex-col space-y-2 rounded-lg bg-white p-4"
          >
          ...
          <img
            ...
            className="absolute right-5 top-[-3px]  rounded-full " // 이미지 크기와 모양 조정
            alt="Description"
          />
          ...
          {message.reply === null ? (
            ...
            >
              <img
                ...
                className="absolute left-[-10px] top-[-3px]  rounded-full" // 이미지 위치와 크기 조정
                alt="Description"
              />
              <div className="flex h-full flex-col items-center justify-center font-cusFont4">
